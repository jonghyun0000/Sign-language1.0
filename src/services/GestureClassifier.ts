  ...
  private allowedCategories(): Category[] | undefined {
    switch (this.dictionary) {
      ...
      case 'word':
        return ['word'];
      case 'smart':
        // 한글 구조상 초성 뒤에는 모음이 옵니다.
        //
        // 중요: 예전에는 여기에 'word'를 항상 함께 넣었습니다. 그런데 혼동
        // 행렬로 측정해 보니 단어 단축 동작이 자모와 손 모양이 겹쳐서
        // (도와주세요 ≡ ㅗ, 감사합니다 ≡ ㅎ, 괜찮아요 ≡ ㅇ) 자모 인식을
        // 망가뜨리고 있었습니다. 이제 단어는 '단어' 모드에서만 인식합니다.
